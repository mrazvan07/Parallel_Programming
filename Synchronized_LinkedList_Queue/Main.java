...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int testCaseNo = Integer.parseInt(args[1]);

        SortedLinkedList resultList = new SortedLinkedList();
        MyQueue queue = new MyQueue();
        String path =  (testCaseNo == 1) ? "D:\\Facultate Semestrul 5\\PPD\\Lab4\\Java\\Lab4_PPD\\data\\test_case1\\" : "D:\\Facultate Semestrul 5\\PPD\\Lab4\\Java\\Lab4_PPD\\data\\test_case2\\";
        ...
        if(p == 0)
            ...
            runParallel(testCaseNo,noThreads,resultList,queue);
    ...
    private static void runSequencial(int testCaseNo, SortedLinkedList resultList){
        ...
        String path =  (testCaseNo == 1) ? "D:\\Facultate Semestrul 5\\PPD\\Lab4\\Java\\Lab4_PPD\\data\\test_case1\\" :
                "D:\\Facultate Semestrul 5\\PPD\\Lab4\\Java\\Lab4_PPD\\data\\test_case2\\";
    ...
    private static void runParallel(int testCaseNo, int noThreads, SortedLinkedList resultList, MyQueue queue) throws InterruptedException {
        int polynomsNo = (testCaseNo == 1) ? 10 : 5;
        String path = (testCaseNo == 1) ? "D:\\Facultate Semestrul 5\\PPD\\Lab4\\Java\\Lab4_PPD\\data\\test_case1\\" :
                "D:\\Facultate Semestrul 5\\PPD\\Lab4\\Java\\Lab4_PPD\\data\\test_case2\\";

        ReaderThread reader = new ReaderThread(path,polynomsNo,queue);
        reader.start();

        WorkerThread[] workers = new WorkerThread[noThreads - 1];
